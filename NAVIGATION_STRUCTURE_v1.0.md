...
| Architects | `/domestic-gardens` | `src/app/domestic-gardens/page.tsx` (to be created) |
| Designers | `/commercial-gardens` | `src/app/commercial-gardens/page.tsx` (to be created) |
...
| Grills | `/garden-design` | `src/app/garden-design/page.tsx` |
| Garden Build | `/garden-build` | `src/app/garden-build/page.tsx` (to be created) |
| Members Club | `/garden-maintenance` | `src/app/garden-maintenance/page.tsx` (to be created) |
...
- **Content:**
  ...
  - Email: `mailto:info@rancherosgrills.com` → "design@rancherosgrills.com"
